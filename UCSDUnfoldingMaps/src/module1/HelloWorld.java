...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 50, 50, 350, 500, new Microsoft.HybridProvider());
		...
		map2 = new UnfoldingMap(this, 430, 50, 350, 500, new Microsoft.HybridProvider());

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map2.zoomAndPanTo(zoomLevel, new Location(22.845641f, 89.5403279f));
